<?php
  ...
  class Dokumen extends CI_Controller {
    ...
    function print_surat($id)
    {
      ...
      $pdf->Cell(0,5,'Yang bertanda tangan di bawah ini, Pengurus RT/RW. '.$rtrw.' Kelurahan Penjaringan Kecamatan Penjaringan,',0,1);
      ...
      $pdf->Cell(90,5,'( Ketua RW. 015 )',0,0,'C');
    ...
    function print_pktp()
    {
      ...
      $data = $this->main->select_pengajuan($where, $between);
        ...
        $pdf->Cell(280,10,'KEL : PENJARINGAN, KEC : PENJARINGAN',0,1,'C');
