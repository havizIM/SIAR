...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card animated zoomInDown" id="animate" style="border:2px solid #034ea2; box-shadow: 0 3px 14px rgba(0, 0, 0, 0.66);">
        <div class="card-body">
          <div class="card-title text-center">
            <h1 style="font-size:30px; font-weight: 700;">KARTU <span style="color:#034ea2;">KELUARGA</span></h1>
            <h2 id="no_kk" style="font-size: 20px"></h2><hr>
          </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title">Tambah Anggota Keluarga</h1>
        ...
        <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nik" value="" id="nik" minlength="16" maxlength="16">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tempat_lahir" value="" id="tempat_lahir">
                </div>
                <div class="form-group">
                  <label for="" class="form-label">Tanggal Lahir</label>
                  <input type="date" class="form-control" name="tgl_lahir" value="" id="tgl_lahir">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="no_kitap" id="no_kitap" value="">
              </div>
              <div class="form-group">
                <label for="" class="form-label">Nama Ayah</label>
                <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" value="">
              </div>
              <div class="form-group">
                <label for="" class="form-label">Nama Ibu</label>
                <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" value="">
              </div>
            </div>
          </div>
