    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-primary">
          <h1 class="card-title" style="font-size:25px; color:#ffffff;">Daftar Pengajuan Surat Pindah</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_report" target="_blank" method="post" action="<?= base_url().'dokumen/print_ppindah' ?>">
